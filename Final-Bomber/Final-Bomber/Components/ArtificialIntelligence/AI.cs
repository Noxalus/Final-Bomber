...
namespace Final_Bomber.Components.ArtificialIntelligence
{
    public static class AI
    {
        ...
        public static Point SetNewGoal(Point position, MapItem[,] map, bool[,] collisionLayer, int[,] hazardMap, Point mapSize) 
        {
        ...
        public static bool TryToPutBomb(Point position, int power, MapItem[,] map, bool[,] collisionLayer, int[,] hM, Point mapSize)
        {

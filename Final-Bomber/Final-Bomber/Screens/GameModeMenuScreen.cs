...
{
    public class GameModeMenuScreen : BaseGameState
    {
        #region Field region
        string[] menuString;
        int indexMenu;
        ...
        public GameModeMenuScreen(Game game, GameStateManager manager)
            : base(game, manager)
        {
            menuString = new string[] { "Partie en local", "Partie en ligne", "Retour" };
            indexMenu = 0;
        }
        #endregion
